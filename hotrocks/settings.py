"""
Django settings for hotrocks project.
...
SECRET_KEY = "django-insecure-3yna)m$78)uu_i^n$#&3k6i0rc!%+d9+5whc^c=y_d-r1)cwzz"
...
WSGI_APPLICATION = "hotrocks.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "HOST": os.environ.get("DATABASE_HOST"),  # For local development,
